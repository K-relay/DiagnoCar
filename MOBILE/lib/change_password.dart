...
class _ChangePasswordScreenState extends State<ChangePasswordScreen> {
  ...
  Future<void> _changePassword(BuildContext context) async {
    ...
    if (response.statusCode == 200) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Center(
            child: Text('گۆڕینی تێپەڕە وشە سەرکەوتوو بوو',style: TextStyle(fontFamily: 'NRT'),),
          ) 
        ),
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('گۆڕینی تێپەڕە وشە', style: TextStyle(color: Colors.white,fontFamily: 'NRT'),),
        leading: IconButton(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ElevatedButton(
              ...
              child: Text('گۆڕین',style: TextStyle(fontFamily: 'NRT'),),
            ),
          ],
        ),
      ),
