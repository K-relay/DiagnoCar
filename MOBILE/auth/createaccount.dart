        ...
        child: SingleChildScrollView(
          child: Form(
            ...
            child: Column(
              ...
              children: [
                SizedBox(height: 10),
                buildTextField('ناوی یەکەم', 'First Name', _firstNameController, Icons.person, isDarkMode),
                buildTextField('ناوی دووەم', 'Last Name', _lastNameController, Icons.person, isDarkMode),
                buildTextField('ناوی بەکارهێنەر', 'Username', _firstNameController, Icons.person, isDarkMode),
                buildTextField('وشەی تێپەڕ', 'Password', _passwordController, Icons.lock, isDarkMode, isPassword: true),
                buildTextField('ڕەقەم موبایل', 'Phone Number', _phoneNumberController, Icons.phone, isDarkMode, isPhoneNumber: true),
                buildTextField('ئیمێڵ', 'Email', _emailController, Icons.email, isDarkMode),
    ...
    return Directionality(
      ...
      child: Container(
        ...
        child: TextFormField(
          ...
          inputFormatters: isPhoneNumber ? [FilteringTextInputFormatter.digitsOnly] : null,
